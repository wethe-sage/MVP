...
export default function ChipInput({
  ...
  const { editListing, listing } = useSelector((state) => state.listing)
    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className="flex w-full flex-wrap gap-y-2">
        ...
        {chips.map((chip, index) => (
          <div
            key={index}
            className="m-1 flex items-center rounded-full bg-[#BCAD3C] px-2 py-1 text-sm text-richblack-5"
          >
